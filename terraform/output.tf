...
output "aks_resource_group" {
  description = "Resource group containing the AKS cluster (same as the main resource group)"
  value       = azurerm_resource_group.rg.name
}

output "get_aks_credentials_command" {
  description = "Azure CLI command to fetch AKS credentials for kubectl"
